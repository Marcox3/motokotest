...
def login():
    ...
    Label(ventana_login, text="numero de la INE * ").pack()
    entrada_login_usuario = Entry(ventana_login, textvariable=verifica_usuario)
    entrada_login_usuario.pack()
    Label(ventana_login, text="").pack()
    Label(ventana_login, text="Metamask * ").pack()

    img = PhotoImage(file='metamask-logo.gif')
    Button(ventana_login, text="Acceder",image=img, width=70, height=70, ).pack()

    Button(ventana_login, text="test", width=500, height=500,justify="right")
